 ...
 * @license MIT
 */
define(["skylark-langx/langx","skylark-graphics-color","./brushes","./TileBrush"],function(r,e,n,u){var t=u.inherit({klassName:"qface/style/ImageBrush",imageSource:{get:function(){return this._.imageSource}},toString:function(){return"url("+this.imageSource+")"},_construct:function(r){this._={imageSource:r}}});return t.fromString=function(r){var e=CssUtils.parseBackgroundImage(r);return"url"==e.type?new t(e.url):null},n.ImageBrush=t});
